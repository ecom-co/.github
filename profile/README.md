...
|:---|:---|:---|
| • **Auth Service** - JWT & authorization<br>• **User Service** - Profile management<br>• **Product Catalogue** - Product data<br>• **Inventory Service** - Stock management | • **Search Service** - Elasticsearch indexing<br>• **Analytics Service** - Business metrics<br>• **Notification Service** - Multi-channel alerts<br>• **Order Service** - Transaction processing | • **Main Service** - API Gateway & routing<br>• **Fulfillment Service** - Shipping & logistics<br>• **RabbitMQ** - Inter-service communication<br>• **Redis** - Caching & sessions |
